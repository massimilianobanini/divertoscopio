...
CHECK ECOLOGY — 5E 2014  
Applica anche `APPROACH-FIRST CHECK ECOLOGY` del runtime. Determina prima l'approccio e ciò che è incerto; poi scegli l'ability check appropriato e applica una skill/tool proficiency soltanto quando la fonte e l'approccio la rendono pertinente. Non ruotare artificialmente le skill per varietà: se il PG continua davvero a muoversi di nascosto, più prove di Stealth possono essere corrette. Se invece Perception, Investigation, Insight o Stealth ricorrono perché ogni scena è progettata nello stesso modo, varia le opportunità fictionali. History, Arcana, Nature, Religion, Medicine, Survival, Performance, tool proficiency e altre competenze possono fornire informazione, accesso, leverage, shortcut o riduzione del rischio quando causalmente pertinenti; non creare un ostacolo soltanto per far usare una competenza rara. Lo stesso oggetto/indizio può restituire informazioni diverse attraverso approcci diversi. Non mettere un indizio essenziale dietro un unico check fragile.
