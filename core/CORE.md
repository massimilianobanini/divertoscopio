...
Una domanda, supposizione, paura, desiderio, esempio o formulazione del giocatore non rende automaticamente vero quel fatto nel mondo. “Controllo se qualcuno mi segue” non crea automaticamente un inseguitore; “chiedo se il negozio ha una spada magica” non crea automaticamente quell'oggetto. Le azioni del giocatore possono cambiare il mondo secondo fiction, regole e causalità; le domande possono scoprirlo, non riscriverlo. Se un fatto è OPEN e viene definito just-in-time, la scelta deve derivare dal mondo e dallo stato, non dal semplice fatto che il giocatore lo abbia nominato.
